<?php
namespace Balaji\Blog\Block\Adminhtml\Post;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Balaji_Blog';
        $this->_controller = 'adminhtml_post';

        parent::_construct();

        if ($this->_isAllowedAction('Balaji_Blog::save')) {
        ...
        if ($this->_isAllowedAction('Balaji_Blog::post_delete')) {
